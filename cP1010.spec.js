...
describe('CP101', function() {
  ...
  for (let i = 0; i < 10; i++) {
    it(`CP101 - Iteration ${i+1}`, async function() {
      // Read CSV file
      fs.createReadStream('./csv/cP101.csv')
        .pipe(csv())
        .on('data', async (data) => {
          // Test name: CP101
    ...
    // 9 | type | css=.form-group:nth-child(4) > #exampleInputEmail1 | mailsfals@cierto.com
    ...
    // 11 | type | id=exampleInputPassword1 | 0000*
