...
describe('CP601', function() {
  ...
  it('CP601', async function() {
    ...
    await driver.findElement(By.name("old_password")).sendKeys("00000")
    // 8 | click | name=new_password | 
    await driver.findElement(By.name("new_password")).click()
    // 9 | type | name=new_password | 4444
    await driver.findElement(By.name("new_password")).sendKeys("4444")
    // 10 | click | name=ver_password | 
    await driver.findElement(By.name("ver_password")).click()
    // 11 | type | name=ver_password | 44444
    await driver.findElement(By.name("ver_password")).sendKeys("44444")
    // 12 | click | name=new_password | 
    await driver.findElement(By.name("new_password")).click()
    // 13 | type | name=new_password | 44444
    await driver.findElement(By.name("new_password")).sendKeys("44444")
